...
describe('Add content resource', () => {
  ...
  it('should update only the content resource description', async () => {
    const updateContentResourceMutation = {
      query: `mutation Update($updateContentResource: ContentResourceUpdateInput!) {
          update(params: $updateContentResource) {
              id
      ...
      variables: {
        updateContentResource: {
          ...
          description: 'updated_content_resource_description_by_test',
          type: 'image'
        }
      }
    }
  ...
  it('should create a new content resource if id is undefined', async () => {
    const updateContentResourceMutation = {
      query: `mutation Update($updateContentResource: ContentResourceUpdateInput!) {
          update(params: $updateContentResource) {
              id
